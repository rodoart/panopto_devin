...
class ProcessConfig:
    ...
    model_table_config_table: str = "panopto_model_table_config_d_t_d"
    email_config_table: str = "panopto_email_config_d_t_d"
    ...
    metric_result_table: str = "panopto_metric_result_d_t_d"
    alert_aggregate_table: str = "panopto_alert_aggregate_d_t_d"
    execution_log_table: str = "panopto_execution_log_d_t_d"
    email_log_table: str = "panopto_email_log_d_t_d"
    staging_control_table: str = "panopto_staging_control_d_t_d"
    variable_summary_table: str = "panopto_variable_summary_d_t_d"
